...
1. Leaflet.js + OpenStreetMap было заменено на 2GIS Map API из-за лучшего покрытия в ЕКатеринбурге, правильное название остановок.
2. Синхронная генерация с кэшированием на 5 минут вместо  Celery + Redis для фоновой обработки.
